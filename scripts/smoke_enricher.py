...
_CASES = [
    ...
    (
        "Нет, в этом тестовом примере я изучаю Python по вечерам, а не по утрам.",
        "expect: intent=correction, learning_signal.type=correction",
    ),
    (
        "В тестовом примере я изучаю Python по вечерам.",
        "expect: intent=statement, learning_signal.type=fact",
    ),
    (
