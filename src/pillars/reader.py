"""Read-only loader for Alexey-owned priority pillars."""
...
def render_default_pillars() -> str:
    """Default template from the architecture plan; Алексей owns real values."""
...
pillars:
  ...
  - id: money
    name: "Заработок денег для Алексея"
    weight: 0.30
