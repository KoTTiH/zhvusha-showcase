...
BUILTIN_DIGITAL_SCENARIOS: tuple[DigitalScenarioDefinition, ...] = (
    ...
    DigitalScenarioDefinition(
        ...
        invariants=(
            ...
            "Не писать людям от имени Алексея без explicit approval.",
    ...
    DigitalScenarioDefinition(
        ...
        task_family=(
            "Семейство задач про рабочий стиль Алексея: решения, rejected wording, "
        ...
        user_stories=(
            "Выведи, какие формулировки Алексей обычно отвергает.",
    ...
    DigitalScenarioDefinition(
        ...
        task_family=(
            "Семейство задач, где намерение Алексея переводится в недельный план, "
