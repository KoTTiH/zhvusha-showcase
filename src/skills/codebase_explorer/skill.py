...
Если Алексей просит сравнить кодовую базу с постом, источником, скрином или
...
def _build_user_prompt(
    *,
    ...
    return (
        "Алексей написал обычный чат-запрос, но он требует живого read-only "
        "анализа проекта.\n\n"
        f"workspace_root: {workspace_root}\n\n"
        "Недавний чат, который может содержать пост/источник/скрин для сравнения:\n"
        f"{recent}\n\n"
        "Текущий запрос Алексея:\n"
        f"{message}\n\n"
        "Что сделать:\n"
