...
# falling back to the private file). Logged as a warning so Alexey notices.
_PUBLIC_FALLBACK_STUB: dict[str, str] = {
    "public_identity.md": (
        "Я — Жвуша 🐊, AI-агент. Создатель — Алексей. "
...
class ContextLoader:
    ...
    # to prevent leaking Alexey's personal details to strangers.
