...
4. ``spec.tier <= self_coding_max_tier``. Tier 3 is allowed only when
   Алексей explicitly raised the configured max tier and approved the spec.
    ...
    def _build_system_prompt(
        ...
        * Everything else (FEATURE / FIX / DOCS) — existing tests are
        ...
        return (
            ...
            "are for Алексей in Telegram; do not mention raw tool calls, shell "
